// video2 for threejs-camera-perspective
// just testing out new model
...
VIDEO.init = function(sm, scene, camera){
    ...
    // LIGHT
    var dl = new THREE.DirectionalLight(0xdfdfdf, 1.0);
    dl.position.set(2, 1, 3);
    scene.add(dl);
    var al = new THREE.AmbientLight(0xdfdfdf, 0.35);
    scene.add(al);
