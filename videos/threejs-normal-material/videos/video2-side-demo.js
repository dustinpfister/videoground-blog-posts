// video2-side.js for threejs-normal-material
VIDEO.scripts = [
...
VIDEO.init = function(sm, scene, camera){
    ...
    const textCube = scene.userData.textCube = CanvasTextCube.create({
        ...
        lineCount: 9,
        lines: [
            ['Mesh Normal Material', 64, 17, 12, 'white'],
            ['and the side', 64, 32, 12, 'white'],
            ['option', 64, 47, 12, 'white'],
            ['( r146 Mar/20/2023 )', 64, 70, 11, 'gray'],
