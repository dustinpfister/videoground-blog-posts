// video1-setfromaxisangle.js for threejs-quaternion
VIDEO.scripts = [
...
arrowHelper.setLength(3.5);
arrowHelper.line.material.linewidth = 8;
...
const updateDemo = function(a1){
    ...
    const deg = 90 * a3;
    e_axis.z = Math.PI / 180 * deg;
    v_axis.set(0,1,0).applyEuler(e_axis);
    const q1 = new THREE.Quaternion();
    q1.setFromAxisAngle( v_axis, Math.PI * 2 * a2 );

    mesh1.quaternion.copy(q1);

    //const e_adjust = new THREE.Euler();
    //e_adjust.z = Math.PI / 180 * deg;
    ...
    const textCube = scene.userData.textCube = CanvasTextCube.create({
        ...
        lineCount: 9,
        lines: [
            ['Quaternion', 64, 17, 13, 'white'],
            ['Set From Axis Angle', 64, 32, 13, 'white'],
            ['Method', 64, 47, 13, 'white'],
            ['( r146 Mar/24/2023 )', 64, 70, 12, 'gray'],
