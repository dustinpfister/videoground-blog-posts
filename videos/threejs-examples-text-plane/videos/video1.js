...
VIDEO.init = function(sm, scene, camera){
    ...
    const seq = scene.userData.seq = seqHooks.create({
        ...
        beforeObjects: function(seq){
            // TEXT Plane r0
            TextPlane.moveTextLines(plane.userData.canObj.state.lines, textLines, seq.bias, 0, 30);
            // TEXT CUBE r1
        ...
        objects: [
            ...
            },
            {
                ...
                update: function(seq, partPer, partBias){
                    // text plane
                    //TextPlane.moveTextLines(plane.userData.canObj.state.lines, textLines, partPer, 0, 30);
                    // camera
            ...
            },
            {
                ...
                update: function(seq, partPer, partBias){
                    // text plane
                    //TextPlane.moveTextLines(plane.userData.canObj.state.lines, textLines, partBias, 0, 30);
                    // camera
